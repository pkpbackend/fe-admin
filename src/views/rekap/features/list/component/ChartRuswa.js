...
const ChartRuswa = ({ tahunUsulan, chartType }) => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Rekapitulasi Usulan Rumah Swadaya </CardTitle>
      </CardHeader>
      <CardBody style={{ minHeight: 400 }}>
        <Row className="g-4 mt-2">
          ...
          {
            chartType === 'pie' ?
            <PieChart dataRekap={mappingData} canvasName={"ChartRuswa"}/>
            :
            chartType === 'bar' &&
            <BarChart dataRekap={mappingData} canvasName={"ChartRuswa"}/>
          }
          </Col>
